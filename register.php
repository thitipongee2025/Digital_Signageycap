...
<body>
    <div class="container-main">
        <div class="card auth-card">
            <div class="card-body">
                <h3 class="card-title text-center">📝 ลงทะเบียนสมาชิก</h3>
                <?php echo $message; ?>
                <form action="register.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-danger d-block mt-2">การเลือก Admin ควรได้รับอนุมัติจากผู้ดูแลสูงสุด</small>
                    </div>

                    <button type="submit" name="register" class="btn btn-success w-100 mt-3">สมัครสมาชิก</button>
                </form>
                <p class="mt-3 text-center register-link">มีบัญชีอยู่แล้ว? <a href="index.php">เข้าสู่ระบบ</a></p>
            </div>
        </div>
    </div>
